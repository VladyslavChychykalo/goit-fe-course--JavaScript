...
function Cashier(name, productDatabase, customerMoney = 0) {
  ...
  this.countTotalPrice = function(order) {
    // const costBread = order.bread * productDatabase.bread;
    // const costMilk = order.milk * productDatabase.milk;
    // const costApples = order.apples * productDatabase.apples;
    // const costCheese = order.cheese * productDatabase.cheese;
    // const totalPrice = costBread + costMilk + costApples + costCheese;
    // return totalPrice;

    let totalSum = 0;
    for (const elem in order) {
      if (products.hasOwnProperty(elem)) {
        totalSum += products[elem] * order[elem];
      }
    }
    return totalSum;
  };
